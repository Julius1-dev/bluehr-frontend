...
// Removed unused Input, Label, Switch imports
...
// Removed unused TIMEZONES constants
  const _TIMEZONES = [
  "Africa/Nairobi",
  "Africa/Nairobi",
  "Africa/Nairobi",
...
// Removed unused DATE_FORMATS constants
const DATE_FORMATS = [
...
// Removed unused TIME_FORMATS constants
const TIME_FORMATS = [
  { value: "12", label: "12-hour (3:45 PM)" },
  { value: "24", label: "24-hour (15:45)" },
];

// Removed unused BACKUP_FREQUENCIES constants
...
// Removed unused BACKUP_RETENTION constants
    ...
    const fetchResourceData = async () => {
      ...
      try {
        ...
        const res = await fetch(
          `${BACKEND_URL}/super-admin/companies/system-health`,
          {
                    ...
                    >
                      <div>
                        ...
                        <div className="text-sm text-muted-foreground">
                          {format(window.startTime, "MMM d, yyyy h:mm a")} -{" "}
