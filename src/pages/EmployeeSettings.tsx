  ...
  const handleChangePassword = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setSecuritySettings((prev) => ({
        ...prev,
        lastPasswordChange:
          data.passwordChangedAt || new Date().toISOString().split("T")[0],
      }));
                    ...
                    <div className="grid grid-cols-3 gap-4">
                      <div className="flex items-center space-x-2">
                        <Switch
                          checked={pref.email}
                          onCheckedChange={() =>
                            handleNotificationToggle(pref.type, "email")
                          }
                        />
                        <Label>Email</Label>
                      </div>
                      <div className="flex items-center space-x-2">
                        <Switch
                          checked={pref.push}
                          onCheckedChange={() =>
                            handleNotificationToggle(pref.type, "push")
                          }
                        />
                        <Label>Push</Label>
                      </div>
                      <div className="flex items-center space-x-2">
                        <Switch
                          checked={pref.sms}
                          onCheckedChange={() =>
                            handleNotificationToggle(pref.type, "sms")
                          }
                        />
                        <Label>SMS</Label>
                      </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="space-y-1">
                        ...
                        <div className="text-lg font-semibold">
                          KES{" "}
                          {profile.basicSalary
                            ? parseFloat(profile.basicSalary).toLocaleString()
                            : "0"}
                        </div>
                      </div>
                      <div className="space-y-1">
