  ...
  useEffect(() => {
    const fetchWalletData = async () => {
      try {
        ...
        if (!response.ok) {
          throw new Error(
            `Failed to fetch wallet data: ${response.status} ${response.statusText}`
          );
        }
        ...
        setCompanyWallet({
          ...
          remainingAfterPayroll:
            (parseFloat(walletData.balance) || 0) - payrollSummary.totalSalary,
          lastDeposit: {
  ...
  useEffect(() => {
    const fetchEmployeesAndDepartments = async () => {
      try {
        ...
        const filtered = Array.isArray(empData)
          ? empData.filter((e: any) => e.role !== "admin")
          : [];
        ...
        setRealSummary({
          ...
          statutoryDeductions:
            totalPAYE + totalSHIF + totalNSSF + totalHousingLevy,
        });
      } catch (_err) {
        setEmployees([]);
        setDepartments([]);
    ...
    <div className="space-y-6 p-4 md:p-6">
      ...
      <div className="flex flex-col lg:flex-row lg:justify-between lg:items-center gap-4">
        <div>
          ...
          <p className="text-gray-500">
            Manage payroll processing, employee payments, and company wallet.
          </p>
        </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-2xl font-semibold">
                  {formatCurrency(companyWallet.balance)}
                </p>
              </div>
            </div>
          ...
          <CardContent className="pt-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-2xl font-semibold">
                  {formatCurrency(realSummary.totalPayroll)}
                </p>
              </div>
            </div>
            <div className="mt-3 flex items-center text-sm text-gray-500">
          ...
          <CardContent className="pt-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-2xl font-semibold">
                  {formatCurrency(realSummary.statutoryDeductions)}
                </p>
              </div>
            </div>
            <div className="mt-3 flex items-center text-sm text-gray-500">
      ...
      >
        ...
        <TabsContent value="payroll" className="space-y-4">
          <PayrollProcessor payrollMonth="June" payrollYear={2025} />
        </TabsContent>
