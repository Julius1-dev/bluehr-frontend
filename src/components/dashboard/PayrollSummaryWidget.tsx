    ...
    const fetchPayrollSummary = async () => {
      ...
      try {
        ...
        const res = await fetch(
          `${BACKEND_URL}/company-admin/payroll/pending-total`,
          {
        ...
        <div className="space-y-4">
          <div className="bg-blue-50 rounded-lg p-4">
            <div className="flex items-center justify-between">
              ...
              <p className="text-sm font-medium">
                {payrollSummary.payrollDate
                  ? new Date(payrollSummary.payrollDate).toLocaleDateString()
                  : "-"}
              </p>
            </div>
            <p className="text-2xl font-bold text-blue-700 mt-1">
              {formatCurrency(payrollSummary.netPayable)}
            </p>
          ...
          <div>
            ...
            <div className="space-y-2">
              ...
              {Array.isArray(payrollSummary.upcomingPayments) &&
              payrollSummary.upcomingPayments.length > 0 ? (
